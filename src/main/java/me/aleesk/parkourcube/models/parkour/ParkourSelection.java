...
public class ParkourSelection {
     ...
     */
    public static ParkourSelection createOrGetSelection(Player player) {
        ...
        player.setMetadata(SELECTION_METADATA_KEY, new FixedMetadataValue(ParkourCube.get(), selection));
