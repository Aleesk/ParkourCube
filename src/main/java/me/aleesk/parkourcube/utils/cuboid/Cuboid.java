package me.aleesk.parkourcube.utils.cuboid;
...
public class Cuboid implements Iterable<Location> {
    ...
    public Location getCenter() {
        return new Location(
                getWorld(), getLowerX() + (double) (getUpperX() - getLowerX()) / 2,
                getLowerY() + (double) (getUpperY() - getLowerY()) / 2, getLowerZ() + (double) (getUpperZ() - getLowerZ()) / 2
        );
    }
    ...
    /**
     * @return blocks edge of the cuboid
     */
    ...
    public List<Location> getEdges() {
        ...
        // Añadir las aristas en los ejes X y Z (manteniendo Y constante en ambos extremos)
        for (int x = x1; x <= x2; x++) {
            edges.add(new Location(world, x, y1, z1)); // Arista inferior (Y1)
            edges.add(new Location(world, x, y1, z2));
            edges.add(new Location(world, x, y2, z1)); // Arista superior (Y2)
            edges.add(new Location(world, x, y2, z2));
        }

        // Añadir las aristas en los ejes Y y Z (manteniendo X constante en ambos extremos)
        for (int z = z1; z <= z2; z++) {
            edges.add(new Location(world, x1, y1, z)); // Arista inferior (Y1)
            edges.add(new Location(world, x2, y1, z));
            edges.add(new Location(world, x1, y2, z)); // Arista superior (Y2)
            edges.add(new Location(world, x2, y2, z));
        }

        // Añadir las aristas en los ejes X y Y (manteniendo Z constante en ambos extremos)
        for (int y = y1; y <= y2; y++) {
            edges.add(new Location(world, x1, y, z1)); // Arista en el borde (Z1)
            edges.add(new Location(world, x2, y, z1));
            edges.add(new Location(world, x1, y, z2)); // Arista en el borde (Z2)
            edges.add(new Location(world, x2, y, z2));
        }
